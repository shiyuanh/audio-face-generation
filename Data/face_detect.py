...
# Read the image
for fn in sorted(os.listdir('../../data/celeba/img_align_celeba/')):
    print(fn)
    image = cv2.imread(os.path.abspath('../../data/celeba/img_align_celeba/' + fn))
    print(os.path.abspath('../../data/celeba/img_align_celeba/' + fn))
